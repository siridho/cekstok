                        ...
                        <div class="table-responsive">
                            <table class="table table-borderless">
                                <tbody>
                                    ...
                                    <tr><th> Kode Customer </th><td> {{ $customer->kode_customer }} </td></tr><tr><th> Nama Perusahaan </th><td> {{ $customer->nama_perusahaan }} </td></tr><tr><th> Nama Customer </th><td> {{ $customer->nama_customer }} </td></tr>
                                </tbody>
                            </table>
                        </div>
